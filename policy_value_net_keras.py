...
def test_keras_environment():
    ...
    print('CPU (s):')
    cpu_time = timeit.timeit('cpu()', number=10, setup="from test_keras_environment import cpu")
    print(cpu_time)
    print('GPU (s):')
    gpu_time = timeit.timeit('gpu()', number=10, setup="from test_keras_environment import gpu")
    print(gpu_time)
