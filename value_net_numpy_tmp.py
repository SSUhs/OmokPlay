...
def get_net_params(net_params_file):
    net_params = pickle.load(open(net_params_file, 'rb'))
    return net_params

class ValueNetTmpNumpy():
    """policy-value network in numpy """
    def __init__(self, board_size, net_params_file):
        self.board_size = board_size
        self.params = get_net_params(net_params_file)

    def value_fn(self, board):
